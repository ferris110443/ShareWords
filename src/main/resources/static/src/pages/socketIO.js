...
//             if (op.roomId === roomId && op.fileId === fileId) {  // Only process messages that belong to the same room
//                 rga.receive(op);
//             }
//         });    // console.log('history', history)
//         socket.emit('message', {type: 'historyRequest', roomId: roomId, fileId: fileId});  // Request history for the room
//     }
//
